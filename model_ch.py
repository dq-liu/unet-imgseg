...
### Description    : Defines the Unet framework. RGB CHANNELS SEPERATED.
...
def get_unet(loss_fun, metric_list):
    ...
    inputs = Input((966, 1296, 1))                                             # 966, 1296, 1
     
    conv1 = Convolution2D(32, 3, activation='relu', padding='same')(inputs)    # 966, 1296, 32
